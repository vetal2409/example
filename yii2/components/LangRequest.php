...
class LangRequest extends Request
{
     ...
     * @return mixed|string
     */
    public function changeLangUrl($url, $lang)
    {
        ...
        if ($url === '/') {
            ...
            return str_replace($baseUrl, "$baseUrl/$lang", $url);
        }
    }
    ...
    protected function resolvePathInfo()
    {
        ...
        } elseif (array_key_exists('PHP_SELF', $_SERVER) && strpos($_SERVER['PHP_SELF'], $scriptUrl) === 0) {
